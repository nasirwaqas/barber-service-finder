...
// export default function CustomerCreateProfile() {
...
//               <h3 className="Register-form-title">Customer Profile Edit</h3>
...
//                 </button>
//                 <Link to="/customer/profile/view" className="btn btn-secondary">
//                   Cancel
//                 </Link>
//               </div>
//             </div>
